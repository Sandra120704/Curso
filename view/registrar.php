...
<body>
  ...
  <div class="container">
    ...
    <form id="formulario-registro" autocomplete="off">
      ...
      <div class="card mt-3">
        <div class="card-header bg-primary text-light">Registro de Materia</div>
        <div class="card-body">
  ...
  <script>
    ...
    form.addEventListener("submit", function (e) {
      e.preventDefault(); // Previene el submit tradicional
      registrarMateria();
    });

    function registrarMateria() {
      fetch("../app/controllers/Materiascontrol.php", {
        method: 'POST',
        ...
        body: JSON.stringify({
          ...
          Duracion_Horas: document.querySelector("#duracion").value,
